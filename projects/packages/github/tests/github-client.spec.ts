...
import { createRepository } from "../src/gql/create-repository";
import { getAllRepositories } from "../src/gql/get-all-repositories";
import { getAllRepositoriesForOwner } from "../src/gql/get-all-repositories-for-owner";
import { isRepositoryArchived } from "../src/gql/is-repository-archived";
import { deleteRepo } from "../src/rest/delete-repo";

jest.mock("../src/gql/create-repository");
jest.mock("../src/gql/get-all-repositories");
jest.mock("../src/gql/get-all-repositories-for-owner");
jest.mock("../src/gql/is-repository-archived");
jest.mock("../src/rest/delete-repo");
